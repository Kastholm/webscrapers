...
page_to_scrape = 'https://www.dagens.com/politics/harris-outlines-conditions-for-meeting-putin-and-remarks-on-netanyahus-status'
    ...
    "mutations": [
        {
            "patch": {
                "id": image_id,
                "set": {
                    "description": article.imageRef # Tilføj billedbeskrivelsen her
                }
            }
        }
        ]
